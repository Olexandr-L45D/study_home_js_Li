...
// калорій, які спортсмен споживав протягом тижня.Функція очікує один параметр:
...
// days це масив, щоб дістатись всередину нього потрібен цикл, тобто в першу
// чергу перебираєте days.На кожній ітерації отримуєте об'єкт day, а вже у нього берете day.calories і саме це значине додаєто до total.
// // // //
...
// ); // 0
// }
// //TASK-2-!!!- Home Work -4 вонано ВІРНО!!!!
// // //TASK-3-!!!- Home Work -4 !!!! вонано ВІРНО!!!!
...
// Значення змінної profile — це об’єкт з
// властивостями
// username,
//   playTime, getInfo, changeUsername і
// updatePlayTime
...
// Для звернення до властивостей об’єкта в його методах
...
//   has < amount > active hours!, де < Username > — це ім’я профілю,
...
// Добрий день.Ваш метод має оновлювати властивість userName в обʼєкті profile,
//   а вона у вас просто рядок створює і нікуди не записує.
//  Це я про метод changeUserName. (нове значення у необхідну властивість записати)

// Метод updatePlayTime має оновлювати властивість playTime, а він також створює
//  рядок і все.Плюс помилка у вас із - за того, що в методі updatePlayTime не
//  доступна зміна  newName. (нове значення у необхідну властивість записати)
