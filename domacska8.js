//8
//таск - 1 - gallery (images = [{preview: original: description:)
// const images = [
//     {
//       preview:
...
//   });
//
//другий варіант збільшення зображення при кліку (моя версія з деструктуризацією масива, в якому є обєкти)
// const galleryContainer = document.querySelector('.gallery')
// galleryContainer.insertAdjacentHTML("afterbegin", createMarkup(images));  
